...
var client = mqtt.connect(!dev ? "mqtt://:1863" : "mqtt://127.0.0.1:1863");
...
var send = function() {
  client.publish(
    "/sgh/111/ctrl",
    create(...Array.prototype.slice.call(arguments, 0))
  );
};
...
var updateBtns = function() {
  ...
  for (var index = 0; index < 5; index++) {
    ...
    var state =
      window.pinState[index] == 1
        ? "/media/btns/" + arr[index] + "_1.png"
        : "/media/btns/" + arr[index] + "_0.png";
    $(i).attr("src", state);
  }
};
